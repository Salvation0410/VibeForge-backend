...
- [ ] **Step 2: Run the parser tests and verify the new cases fail**
...
- [ ] **Step 3: Implement validator records and service**
...
- [ ] **Step 5: Commit version publication**
...
- [ ] **Step 2: Run resolver tests and verify missing integrations**
...
- [ ] **Step 3: Inject and use `ArtifactPathResolver`**
...
- [ ] **Step 4: Run artifact and affected service tests**
...
- [ ] **Step 4: Run lease and application service tests**

Run: `mvn -q -Dtest=GenerationLeaseServiceTest,AppServicePublicPageTest test`

Expected: all tests pass.

- [ ] **Step 5: Commit generation exclusion**
...
- [ ] **Step 1: Add failing Legacy stream tests**
...
- [ ] **Step 2: Run the Legacy stream tests and verify they fail**
...
- [ ] **Step 3: Convert simple generation methods to `TokenStream`**
...
- [ ] **Step 4: Keep failed candidates out of successful history**
...
- [ ] **Step 3: Integrate `ArtifactPipeline` behavior**
...
- [ ] **Step 3: Map terminal errors explicitly**
...
- [ ] **Step 4: Extend frontend error typing**
...
- [ ] **Step 5: Run backend SSE tests and frontend type check**
...
- [ ] **Step 6: Commit SSE and frontend changes**
...
- [ ] **Step 4: Rebuild the workflow gates**
...
- [ ] **Step 6: Commit LangGraph integration**
...
- [ ] **Step 2: Verify Chinese method documentation**
...
- [ ] **Step 6: Check diffs and repository state**
