...
(
    ...
    status     VARCHAR(32) DEFAULT 'APPROVED'      NOT NULL COMMENT '审核状态：APPROVED/REJECTED',
    likeCount  INT       DEFAULT 0                 NOT NULL COMMENT '点赞数',
    ...
    updateTime DATETIME  DEFAULT CURRENT_TIMESTAMP NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    isDelete   TINYINT   DEFAULT 0                 NOT NULL COMMENT '逻辑删除',
    INDEX idx_community_comment_status_time (status, createTime, id),
    INDEX idx_community_comment_parent_status_time (postId, parentId, status, createTime, id),
